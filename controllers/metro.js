...
exports.getMetroScores = async (req, res) => {
    const text = "SELECT metro_name, cbsa, COALESCE(pop_score,0) + COALESCE(pop_grow_score,0)+ COALESCE(emp_score,0)+ COALESCE(grp_score,0)+ COALESCE(grp_grow_score,0)+ COALESCE(unemp_score,0) AS total, pop_score, pop_grow_score, emp_score, grp_score, grp_grow_score, unemp_score FROM metro_score";
...
exports.getMetroScore = async (req, res) => {
    const text = "SELECT metro_name, cbsa, COALESCE(pop_score,0) + COALESCE(pop_grow_score,0)+ COALESCE(emp_score,0)+ COALESCE(grp_score,0)+ COALESCE(grp_grow_score,0)+ COALESCE(unemp_score,0) AS total, pop_score, pop_grow_score, emp_score, grp_score, grp_grow_score, unemp_score FROM metro_score WHERE cbsa = $1";
